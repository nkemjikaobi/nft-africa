					...
					>
						...
						<div className='tablet:w-3/4 tablet:mt-2 smallLaptop:mt-0'>
							...
							<p className='text-sm mb-8 -ml-20 tablet:ml-0'>
								The GIIIO alien NFT is an important asset to the GIIIO
								metaverse, an identity symbol for participation in the GIIIO
								planet game, and an important player in the game, production and
								construction!
							</p>
